...
void *thread_router(void *arguments) {

    struct arg_struct *args = arguments;
    zsock_t *router = args->arg1;
    Player *list_players = args->arg2;
    ...
    while (!zsys_interrupted) {
        ...
        if (message != NULL) {
            ...
            resp_server = exec_command(zframe_strdup(identity), zframe_strdup(content), list_players);
...
int main(int argc, char *argv[])
{
    ...
    // Players Init
    Player *list_players, players;
    list_players = &players;
    // list_players = NULL;
    // list_players = add_player(list_players, "#0100");
    ...
    // Assing args to the thread
    struct arg_struct args;
    args.arg1 = router;
    args.arg2 = list_players;

    // Init Thread
    pthread_t throuter;
    pthread_create (&throuter, NULL, (void *) thread_router, (void *)&args);
